...
"""
parse the PASCAL VOC dateset xml file to txt file.
by Earl Du
duzexu92@gmail.com
"""
...
if __name__ == '__main__':
    ...
    txt_file = open('voc2007_test.txt', 'w')
    # test_file = open('voc07testimg.txt', 'r')
    # lines = test_file.readlines()
    # lines = [x[:-1] for x in lines]
    # print(lines)

    # Annotations = '/home/dzx/workSpace/yolo/EarlDU/dataset/VOCdevkit/VOC2012/Annotations/'
    Annotations = '/home/dzx/workSpace/yolo/EarlDU/dataset/VOCdevkit/VOC2007_test/Annotations/'
